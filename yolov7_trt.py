...
class YoLov7_TRT(object):
    ...
    def __init__(self, engine_file_path, conf_threshold, iou_threshold):
        ...
        # self.GPIO_socket_thread = SocketGPIOThread()
        # self.GPIO_socket_thread.start()
        # self.GPIO_output = SocketOutput("192.168.254.100", 12000)
    ...
    def preprocess_image(self, image):
        ...
        param:
            image: hsv-normalised RGB image
        return:
        ...
        image = cv2.copyMakeBorder(
            image, ty1, ty2, tx1, tx2, cv2.BORDER_CONSTANT, None, (0.5, 0.5, 0.5)
        )
        # print("after_padding",image.shape)
        # cv2.imshow("",image)
    ...
    def post_process(self, output, origin_h, origin_w):
        ...
        # Do nms
        boxes = self.non_max_suppression(pred, origin_h, origin_w, conf_thres=self.conf_threshold,
